...
data class Vec2i(var x: Int, var y: Int) {
    ...
    inline operator fun plus(other: Vec2i) =
        Vec2i(x + other.x, y + other.y)
    inline operator fun minus(other: Vec2i) =
        Vec2i(x - other.x, y - other.y)
    inline operator fun times(other: Vec2i) =
        Vec2i(x * other.x, y * other.y)
    inline operator fun times(other: Int) = Vec2i(x * other, y * other)
    inline operator fun div(other: Vec2i) =
        Vec2i(x / other.x, y / other.y)
