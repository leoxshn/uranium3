...
class ShaderWithGeometry(vertexPath: String, geometryPath: String, fragmentPath: String) {

    private val vertexFile = Resources.loadAsString(vertexPath)
    private val geometryFile = Resources.loadAsString(geometryPath)
    ...
    fun create() {
        ...
        if (GL20.glGetShaderi(geometryID, GL20.GL_COMPILE_STATUS) == GL11.GL_FALSE) {
            System.err.println("[SHADER ERROR - Geometry Shader]: " + GL20.glGetShaderInfoLog(geometryID))
            return
        }
